      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card className="lg:col-span-1 md:col-span-2">
          ...
          <CardContent className="space-y-3">
            <Image src="https://today.thefinancialexpress.com.bd/uploads/1708440577.jpg" alt="কৃষি টিপস" width={600} height={400} className="rounded-lg object-cover aspect-video" data-ai-hint="farming agriculture" />
